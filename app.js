...
const columns = {
  hits: ['player', 'team', 'opponent', 'gameTime', 'games', 'atBats', 'hits', 'hr', 'ba', 'lastGameDate'],
  hr: ['player', 'games', 'hr', 'lastGameDate'],
  pitcherKs: ['player', 'team', 'opponent', 'gameTime', 'line', 'last10Avg', 'last5Avg', 'h2hAvg', 'h2hGames', 'projection', 'edge', 'pick']
};
...
function renderPitcherBars(pitcher, tab) {
  ...
  note.textContent = hasLine
    ...
    : `No live PrizePicks line was available. Green means the pitcher went over the model projection of ${formatValue(pitcher.projection)}.`;
}
